  ...
  return (
    <div className="demo-page">
      <style>{`
        ...
        .demo-grid{display:grid;grid-template-columns:1fr 1fr;gap:48px;align-items:start;padding:32px 0 80px}
        .demo-points{margin:8px 0 0}
        ...
        @media (max-width:820px){
          .demo-grid{grid-template-columns:1fr;gap:28px;padding:24px 0 64px}
          .demo-hero{padding:36px 0 4px}
        }
      `}</style>
