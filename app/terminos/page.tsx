  ...
  return (
    <div className="legal-page">
      ...
      <div className="legal-wrap">
        ...
        <div className="legal-summary">
          ...
          <ul>
            ...
            <li><strong>Tus datos:</strong> los datos personales se rigen por la <a href="/privacidad">Política de Privacidad</a>.</li>
          </ul>
        ...
        <ul>
          <li>Razón social: MiCert Digital SpA (nombre de fantasía: MiCert), en adelante "MiCert" o "el Prestador"</li>
          <li>RUT: 78.454.247-5</li>
          <li>Domicilio: comuna de Las Condes, Región Metropolitana de Santiago</li>
          <li>Email: hola@micert.cl</li>
        ...
        <ul>
          <li><strong>CLIENTE:</strong> organización (persona jurídica) que contrata los servicios de MiCert. Típicamente un OTEC u organización capacitadora.</li>
          <li><strong>PLAN:</strong> paquete de servicios con tarifas y funcionalidades específicas, según se publica en el sitio o se acuerda mediante propuesta comercial.</li>
          <li><strong>CERTIFICADO DIGITAL:</strong> documento electrónico generado por la plataforma que acredita la participación o aprobación de un curso o capacitación.</li>
          <li><strong>VERIFICACIÓN ONLINE:</strong> consulta del estado de un certificado mediante su código QR o código corto, contra la página pública de verificación de MiCert (app.micert.cl). Requiere conexión a internet.</li>
          <li><strong>TITULAR:</strong> persona natural que recibe el certificado digital (participante del curso o capacitación).</li>
          <li><strong>TARIFA:</strong> precio del plan contratado, expresado en pesos chilenos (CLP) más IVA cuando corresponda.</li>
          <li><strong>DÍAS HÁBILES:</strong> días de lunes a viernes, excluyendo feriados legales en Chile.</li>
          <li><strong>TRAZABILIDAD:</strong> registro cronológico de las acciones realizadas sobre los certificados en la plataforma.</li>
        </ul>
        ...
        <ul>
          <li>La <a href="/privacidad">Política de Privacidad</a> disponible en www.micert.cl/privacidad</li>
          <li>Las tarifas y condiciones específicas del plan contratado</li>
          <li>El Anexo de Tratamiento de Datos (DPA) cuando aplique</li>
        </ul>
        ...
        <ul>
          <li><strong>Ciclo de facturación:</strong> mensual o anual, según el plan contratado.</li>
          <li><strong>Método de pago:</strong> transferencia bancaria a la cuenta que MiCert indique al Cliente.</li>
          <li><strong>Moneda:</strong> pesos chilenos (CLP).</li>
          <li><strong>Documentación tributaria:</strong> MiCert emite la documentación tributaria correspondiente (boleta o factura electrónica) por cada pago recibido, conforme a la normativa del SII.</li>
        </ul>
        ...
        <ul>
          ...
          <li><strong>Día 90 corrido:</strong> eliminación de los datos operacionales, conservando los registros legalmente requeridos según la Sección 7.6.</li>
        </ul>
        ...
        <ul>
          <li><strong>Descarga por el Cliente:</strong> disponible por 90 días corridos adicionales después de la cancelación, en formato PDF individual o ZIP.</li>
          ...
          <li><strong>Trazabilidad histórica:</strong> los registros de auditoría se conservan cinco años, conforme a los requisitos de SENCE, y quedan disponibles para auditorías gubernamentales.</li>
        </ul>
        ...
        <p>El tratamiento de datos personales se rige por la Ley N° 21.719 y por la <a href="/privacidad">Política de Privacidad</a> de MiCert, que forma parte integral de estos términos. Conforme a ella, MiCert actúa como <strong>Responsable</strong> respecto de los datos del Cliente-organización y su usuario administrador, y como <strong>Encargado</strong> respecto de los datos de los titulares de certificados aportados por el Cliente.</p>
        <p>Cuando MiCert actúa como Encargado, conforme al artículo 15 ter de la Ley 21.719 debe existir un Anexo de Tratamiento de Datos (DPA) firmado entre el Cliente y MiCert. El Cliente puede solicitar la plantilla a hola@micert.cl.</p>
        ...
        <p>Estos Términos, junto con la Política de Privacidad y el Anexo de Tratamiento de Datos cuando aplique, constituyen el acuerdo completo entre las partes. Si alguna disposición es declarada inválida, las demás permanecerán en pleno vigor. La falta de ejercicio de un derecho por parte de MiCert no constituye renuncia a dicho derecho. El Cliente no puede ceder sus derechos sin consentimiento previo por escrito de MiCert; MiCert puede ceder este contrato en caso de fusión, adquisición o venta de activos, notificando al Cliente. Las notificaciones a MiCert se envían a hola@micert.cl; al Cliente, al email registrado en la cuenta. Este contrato se redacta en español y prevalece esa versión.</p>
      ...
      <div className="legal-foot">
        © 2026 MiCert Digital SpA · <a href="/privacidad">Política de Privacidad</a> · Hecho en Chile
      </div>
    </div>
  );
}
